...
//    currentDay();
    ...
    async function displayTables(tables, tablesWithInvoices) {
        ...
        try {
            ...
            async function display(tablesToDisplay, activeButton) {
                ...
                tablesToDisplay.forEach((table, index) => {
                    ...
                    // Example check for tables with invoices
                    // if (tablesWithInvoices.includes(table.tableId.toString())) {
                    //     tableDiv.classList.add('has_invoice');
                    // }
